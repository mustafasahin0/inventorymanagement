/*
  ...
  - You are about to drop the column `purchasesSummaryId` on the `PurchaseSummary` table. All the data in the column will be lost.
...
DROP COLUMN "purchasesSummaryId",
